...
model_save_path = "/groups/CS156b/2025/ChexMix/kz_models/pleural_effusion/resnet_pe.pt"
...
plt.title("ROC Curve")
plt.legend()
plt.savefig(img_dir + "pe_resnet_roc_curve.png")
...
plt.savefig(img_dir + "pe_resnet_pr_curve.png")
