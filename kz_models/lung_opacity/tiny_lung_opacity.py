...
plt.title("ROC Curve")
plt.legend()
plt.savefig(img_dir + "lung_opacity_tiny_roc_curve.png")
...
plt.savefig(img_dir + "lung_opacity_tiny_pr_curve.png")

# save trained model weights
model_save_path = "/groups/CS156b/2025/ChexMix/kz_models/lung_opacity/tiny_lung_opacity.pt"
